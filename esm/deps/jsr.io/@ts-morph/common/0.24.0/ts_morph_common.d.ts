...
export class DocumentRegistry {
    static "__#52@#initialVersion": string;
...
export class FileUtils {
    static "__#46@#standardizeSlashesRegex": RegExp;
    static "__#46@#trimSlashStartRegex": RegExp;
    static "__#46@#trimSlashEndRegex": RegExp;
    ...
    static "__#46@#splitPathBySlashes"(fileOrDirPath: any): any;
