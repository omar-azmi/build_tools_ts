...
function __wbg_adapter_48(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__hef0d87d0ab17435f(arg0, arg1, addHeapObject(arg2));
}
/**
 * @param {any} roots
 * @param {Function} load
 ...
 * @returns {Promise<any>}
 */
export function createGraph(roots, load, maybe_default_jsx_import_source, maybe_jsx_import_source_module, maybe_cache_info, maybe_resolve, maybe_resolve_types, maybe_graph_kind, maybe_imports) {
    ...
    const ret = wasm.createGraph(addHeapObject(roots), addHeapObject(load), ptr0, len0, ptr1, len1, isLikeNone(maybe_cache_info) ? 0 : addHeapObject(maybe_cache_info), isLikeNone(maybe_resolve) ? 0 : addHeapObject(maybe_resolve), isLikeNone(maybe_resolve_types) ? 0 : addHeapObject(maybe_resolve_types), ptr2, len2, addHeapObject(maybe_imports));
 ...
 * @returns {any}
 */
export function parseModule(specifier, maybe_headers, maybe_default_jsx_import_source, maybe_jsx_import_source_module, content, maybe_resolve, maybe_resolve_types) {
    try {
        ...
        wasm.parseModule(retptr, ptr0, len0, addHeapObject(maybe_headers), ptr1, len1, ptr2, len2, ptr3, len3, isLikeNone(maybe_resolve) ? 0 : addHeapObject(maybe_resolve), isLikeNone(maybe_resolve_types) ? 0 : addHeapObject(maybe_resolve_types));
...
function __wbg_adapter_103(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__hacc66afbda72042a(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
const imports = {
...
export async function instantiateWithInstance(opts) {
    const { instance } = await loader.load(opts?.url ?? new URL("deno_graph_wasm_bg.wasm", import.meta.url), opts?.decompress);
