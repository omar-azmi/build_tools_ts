...
export function parseModule(specifier, maybe_headers, maybe_default_jsx_import_source, maybe_default_jsx_import_types_source, maybe_jsx_import_source_module, content, maybe_resolve, maybe_resolve_types) {
    try {
        ...
        wasm.parseModule(retptr, ptr0, len0, addHeapObject(maybe_headers), ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, isLikeNone(maybe_resolve) ? 0 : addHeapObject(maybe_resolve), isLikeNone(maybe_resolve_types) ? 0 : addHeapObject(maybe_resolve_types));
