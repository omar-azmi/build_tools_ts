...
import CodeBlockWriter from "../../../../../@david/code-block-writer/13.0.3/mod.js";
import { runTestDefinitions } from "./test_runner.js";
    ...
    writer.write("async function main()").block(() => {
        ...
        writer.write("for (const [i, filePath] of filePaths.entries())")
            ...
            if (options.includeScriptModule) {
                ...
                writer.writeLine(`console.log("Running tests in " + pc.underline(scriptPath) + "...\\n");`);
