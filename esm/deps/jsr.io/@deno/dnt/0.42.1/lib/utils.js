...
export async function runCommand(opts) {
    ...
    try {
        ...
        if (!output.success) {
            throw new Error(`${opts.cmd.join(" ")} failed with exit code ${output.code}`);
        }
    }
    catch (err) {
...
export function getDntVersion(url = globalThis[Symbol.for("import-meta-ponyfill-esmodule")](import.meta).url) {
