...
export const transformImportMeta = (context) => {
    ...
    function visitNode(node) {
        ...
        if (ts.isCallExpression(node) &&
            ...
            return ts.visitEachChild(getReplacementImportMetaResolve(node.arguments), visitNode, context);
        }
    ...
    function isImportMetaProp(node) {
    ...
    function getReplacementImportMetaUrl() {
        ...
        return factory.createPropertyAccessExpression(factory.createCallExpression(factory.createPropertyAccessExpression(factory.createCallExpression(factory.createIdentifier("require"), undefined, [factory.createStringLiteral("url")]), factory.createIdentifier("pathToFileURL")), undefined, [factory.createIdentifier("__filename")]), factory.createIdentifier("href"));
    }
    ...
    function getReplacementImportMetaResolve(args) {
        // Copy and pasted from ts-ast-viewer.com
        // new URL(specifier, import.meta.url).href
        return factory.createPropertyAccessExpression(factory.createNewExpression(factory.createIdentifier("URL"), undefined, [
            ...args,
