...
export interface PluginBuild {
    ...
    onResolve(options: OnResolveOptions, callback: (args: OnResolveArgs) => Promise<OnResolveResult | undefined>): void;
    /** Documentation: https://esbuild.github.io/plugins/#on-load */
    onLoad(options: OnLoadOptions, callback: (args: OnLoadArgs) => Promise<OnLoadResult | null | undefined> | undefined): void;
}
...
//# sourceMappingURL=esbuild_types.d.ts.map