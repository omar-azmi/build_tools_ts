...
import { join } from "../../path/1.0.0-rc.1/join.js";
import { normalize } from "../../path/1.0.0-rc.1/normalize.js";
...
export async function* walk(root, options = {}) {
    const { maxDepth = Infinity, includeFiles = true, includeDirs = true, includeSymlinks = true, followSymlinks = false, canonicalize = true, exts = undefined, match = undefined, skip = undefined, } = options;
    if (maxDepth < 0) {
        return;
    }
