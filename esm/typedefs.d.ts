...
export type { DntBuildOptions, PackageJson } from "./deps.js";
...
export type WritableFileConfig = [
    destination: string,
    content: string | ReadableStream<string> | Uint8Array | ReadableStream<Uint8Array>,
    options?: dntShim.Deno.WriteFileOptions
];
