...
import { fromFileUrl } from "../../../@std/path/0.223.0/mod.js";
import * as colors from "../../../@std/fmt/0.223.0/colors.js";
import type { LoadResponse } from "../../graph/0.73.1/mod.js";
...
export class FileFetcher {
  ...
  async fetch(
    ...
    throw new dntShim.Deno.errors.Http(
      `Too many redirects.\n  Specifier: "${specifier.toString()}"`,
    );
  }
